...
\033[1;39m                #║ - - - - - -- - - -[ NVB.x.SMS Spam Panel 2022 ]- - - - - - - - - -║#
\033[1;39m                #║══════════════════>> Nguyễn Việt Bách Profile :                    ║#  
\033[1;39m                #║FB Nguyễn VIệt Bách : https://www.facebook.com/vietbach.x.user     ║# 
\033[1;39m                #║Zalo Việt Bách : 0989231486                                        ║#  
\033[1;39m                #║nvb la nguoi dep chai s1tg                                         ║#  
\033[1;39m                #║                                                                   ║#  
\033[1;39m                #║ ═════════════════════════════════════════════════════════════════ ║#  
...
\033[1;39m                #╚═══════════════════════════════════════════════════════════════════╝#  
\033[1;39m © Code by NguyenVietBach
                               \n\n'''
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('*', 'NguyenVietBach:)'))
